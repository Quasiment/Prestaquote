...
if ($template == 'order_conf'){
	$message->attach(\Swift_Attachment::newInstance(file_get_contents('responsabilite_decennale.pdf'), 'responsabilite_decennale.pdf', 'application/pdf'));
	$message->attach(\Swift_Attachment::newInstance(file_get_contents('RIB Poncet SAS.pdf'), 'RIB Poncet SAS.pdf', 'application/pdf'));
} 
